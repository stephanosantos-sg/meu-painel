const ACHIEVEMENT_CATS = {
  '🚀 Primeiros Passos': [{
    ...
    desc: 'Marque um hábito pela primeira vez',
    icon: '⭐',
    xp: 20
  }, {
    id: 'first_goal',
    name: 'Primeiro Objetivo',
    desc: 'Crie um objetivo',
    icon: '🎯',
    xp: 15
  }, {
    id: 'first_note',
    ...
    id: 'first_idea',
    name: 'Criativo',
    desc: 'Registre uma ideia',
    icon: '💡',
    xp: 15
  }, {
    id: 'categories_3',
    name: 'Organizado',
    desc: 'Crie 3 categorias',
    icon: '🏷️',
    xp: 20
  }],
  '🔥 Consistência': [{
    ...
    id: 'streak_21',
    name: 'Formador de Hábito',
    desc: '21 dias — virou rotina!',
    icon: '💎',
    xp: 200
  }, {
    id: 'streak_30',
    ...
    id: 'streak_365',
    name: 'Um Ano Inteiro',
    desc: '365 dias seguidos',
    icon: '🌟',
    xp: 2000
  }, {
    id: 'all_habits_day',
    name: 'Dia Perfeito',
    desc: 'Todos os hábitos do dia',
    icon: '💯',
    xp: 50
  }],
  '📋 Produtividade': [{
  ...
  '⭐ Hábitos': [{
    id: 'habits_3',
    name: 'Triplo Hábito',
    desc: '3 hábitos ativos',
    icon: '🧠',
    xp: 20
  }, {
    id: 'habits_5',
    name: 'Multi-hábitos',
    desc: '5 hábitos ativos',
    icon: '🧠',
    xp: 40
  }, {
    id: 'habits_10',
    name: 'Hábito Master',
    desc: '10 hábitos ativos',
    icon: '🌀',
    xp: 80
  }, {
    id: 'habit_year_100',
    name: 'Dedicado',
    desc: '100 marcações no ano',
    icon: '📅',
    xp: 60
  }, {
    id: 'habit_year_300',
    name: 'Disciplinado',
    desc: '300 marcações no ano',
    icon: '📅',
    xp: 200
  }],
  '📖 Leitura': [{
    ...
    id: 'book_rated_5',
    name: 'Avaliador',
    desc: 'Avalie 5 livros com estrelas',
    icon: '⭐',
    xp: 30
  }],
  '🎬 Mídia': [{
    id: 'media_watch',
    name: 'Cinéfilo',
    desc: '10 filmes ou séries assistidos',
    icon: '🎬',
    xp: 60
  }, {
    id: 'media_watch_50',
    name: 'Maratonista',
    desc: '50 filmes ou séries',
    icon: '🎬',
    xp: 200
  }, {
    id: 'media_watch_100',
    name: 'Crítico',
    desc: '100 filmes ou séries',
    icon: '🎥',
    xp: 400
  }, {
    id: 'series_binge',
    name: 'Maratonista de Séries',
    desc: 'Termine 5 séries',
    icon: '📺',
    xp: 100
  }],
  '🎯 Objetivos': [{
    ...
    desc: 'Conclua 1 objetivo',
    icon: '🎯',
    xp: 100
  }, {
    id: 'goals_3',
    name: 'Realizador',
    desc: '3 objetivos concluídos',
    icon: '🏅',
    xp: 250
  }, {
    id: 'goals_5',
  ...
  '🛒 Especiais': [{
    ...
    desc: 'Complete um pomodoro',
    icon: '🍅',
    xp: 15
  }, {
    id: 'shoplist_done',
    name: 'Compras Feitas',
    desc: 'Conclua uma lista de compras',
    icon: '🛒',
    xp: 30
  }, {
    id: 'xp_1000',
...
function checkAchievements(D) {
  ...
  function countDone() {
    ...
    D.tasks.forEach(t => {
      if (t.done) c++;
      c += Object.keys(t.doneSlots || {}).length;
    });
    return c;
  }
