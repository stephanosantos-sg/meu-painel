...
function applyTheme(themeId) {
  ...
  if (themeId === 'default' || !themeId) {
    const props = ['--bg-0', '--bg-1', '--bg-2', '--bg-3', '--neon-a', '--neon-b', '--neon-c', '--ink-0', '--ink-1', '--ink-2', '--ink-3', '--ink-4', '--line', '--line-2', '--glass-bg', '--glass-bg-strong', '--glass-border', '--glass-border-hover', '--gradient-neon', '--gradient-neon-soft', '--neon-glow', '--shadow-card', '--shadow-float', '--glass-blur', '--glass-blur-strong'];
...
function ThemePicker({
  ...
  return React.createElement("div", {
  ...
  }, React.createElement("h2", null, "Temas"), React.createElement("button", {
    ...
    return React.createElement("div", {
    ...
    }, theme.name), React.createElement("div", {
      style: {
        position: 'absolute',
        bottom: 12,
        left: 16,
      ...
      style: {
        ...
        height: 6,
        borderRadius: 3,
        background: theme.line.replace('0.08', '0.3')
      }
