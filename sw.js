/* Orbita v2 Service Worker — build v90 */
const CACHE = 'orbita-v90';
const SHELL = [
  "js/data.js?v=90",
  "js/helpers.js?v=90",
  "js/emoji-picker.js?v=90",
  "js/achievements.js?v=90",
  "js/themes.js?v=90",
  "js/shell.js?v=90",
  "js/modals.js?v=90",
  "js/today.js?v=90",
  ...
  "js/finance.js?v=90",
  "js/settings.js?v=90",
  "js/orbita-ai.js?v=90",
  "js/notes.js?v=90",
  "js/media.js?v=90",
  "js/history.js?v=90",
  "js/charts.js?v=90",
  "js/weekly.js?v=90",
  "js/onboarding.js?v=90",
  "js/landing.js?v=90",
  "js/screens.js?v=90",
  "js/app.js?v=90",
  "js/sprites.js?v=90",
  "js/legio-avatars.js?v=90",
  "js/google-calendar.js?v=90",
  "js/firebase-sync.js?v=90",
  "js/utils.js?v=90",
  "js/notify.js?v=90",
  "css/tokens.css?v=90",
  "css/app.css?v=90",
