/* Orbita v2 Service Worker — build v96 */
const CACHE = 'orbita-v96';
const SHELL = [
  "js/data.js?v=96",
  "js/helpers.js?v=96",
  "js/emoji-picker.js?v=96",
  "js/achievements.js?v=96",
  "js/themes.js?v=96",
  "js/shell.js?v=96",
  "js/modals.js?v=96",
  "js/today.js?v=96",
  ...
  "js/app.js?v=96",
  "js/sprites.js?v=96",
  "js/legio-avatars.js?v=96",
  "js/google-calendar.js?v=96",
  "js/firebase-sync.js?v=96",
  "js/utils.js?v=96",
  "js/notify.js?v=96",
  "css/tokens.css?v=96",
  "css/app.css?v=96",
