/* Orbita v2 Service Worker — build v95 */
const CACHE = 'orbita-v95';
const SHELL = [
  "js/data.js?v=95",
  "js/helpers.js?v=95",
  "js/emoji-picker.js?v=95",
  "js/achievements.js?v=95",
  "js/themes.js?v=95",
  "js/shell.js?v=95",
  "js/modals.js?v=95",
  "js/today.js?v=95",
  ...
  "js/app.js?v=95",
  "js/sprites.js?v=95",
  "js/legio-avatars.js?v=95",
  "js/google-calendar.js?v=95",
  "js/firebase-sync.js?v=95",
  "js/utils.js?v=95",
  "js/notify.js?v=95",
  "css/tokens.css?v=95",
  "css/app.css?v=95",
