/* Orbita v2 Service Worker — build v92 */
const CACHE = 'orbita-v92';
const SHELL = [
  "js/data.js?v=92",
  "js/helpers.js?v=92",
  "js/emoji-picker.js?v=92",
  "js/achievements.js?v=92",
  "js/themes.js?v=92",
  "js/shell.js?v=92",
  "js/modals.js?v=92",
  "js/today.js?v=92",
  ...
  "js/finance.js?v=92",
  "js/settings.js?v=92",
  "js/orbita-ai.js?v=92",
  "js/notes.js?v=92",
  "js/media.js?v=92",
  "js/history.js?v=92",
  "js/charts.js?v=92",
  "js/weekly.js?v=92",
  "js/onboarding.js?v=92",
  "js/landing.js?v=92",
  "js/screens.js?v=92",
  "js/app.js?v=92",
  "js/sprites.js?v=92",
  "js/legio-avatars.js?v=92",
  "js/google-calendar.js?v=92",
  "js/firebase-sync.js?v=92",
  "js/utils.js?v=92",
  "js/notify.js?v=92",
  "css/tokens.css?v=92",
  "css/app.css?v=92",
