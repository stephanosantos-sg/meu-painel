/* Orbita v2 Service Worker — build v98 */
const CACHE = 'orbita-v98';
const SHELL = [
  "js/data.js?v=98",
  "js/helpers.js?v=98",
  "js/emoji-picker.js?v=98",
  "js/achievements.js?v=98",
  "js/themes.js?v=98",
  "js/shell.js?v=98",
  "js/modals.js?v=98",
  "js/today.js?v=98",
  ...
  "js/finance.js?v=98",
  "js/settings.js?v=98",
  "js/orbita-ai.js?v=98",
  "js/notes.js?v=98",
  "js/media.js?v=98",
  "js/history.js?v=98",
  "js/charts.js?v=98",
  "js/weekly.js?v=98",
  "js/onboarding.js?v=98",
  "js/landing.js?v=98",
  "js/screens.js?v=98",
  "js/app.js?v=98",
  "js/sprites.js?v=98",
  "js/legio-avatars.js?v=98",
  "js/google-calendar.js?v=98",
  "js/firebase-sync.js?v=98",
  "js/utils.js?v=98",
  "js/notify.js?v=98",
  "css/tokens.css?v=98",
  "css/app.css?v=98",
