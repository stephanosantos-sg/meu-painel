/* Orbita v2 Service Worker — build v91 */
const CACHE = 'orbita-v91';
const SHELL = [
  "js/data.js?v=91",
  "js/helpers.js?v=91",
  "js/emoji-picker.js?v=91",
  "js/achievements.js?v=91",
  "js/themes.js?v=91",
  "js/shell.js?v=91",
  "js/modals.js?v=91",
  "js/today.js?v=91",
  ...
  "js/finance.js?v=91",
  "js/settings.js?v=91",
  "js/orbita-ai.js?v=91",
  "js/notes.js?v=91",
  "js/media.js?v=91",
  "js/history.js?v=91",
  "js/charts.js?v=91",
  "js/weekly.js?v=91",
  "js/onboarding.js?v=91",
  "js/landing.js?v=91",
  "js/screens.js?v=91",
  "js/app.js?v=91",
  "js/sprites.js?v=91",
  "js/legio-avatars.js?v=91",
  "js/google-calendar.js?v=91",
  "js/firebase-sync.js?v=91",
  "js/utils.js?v=91",
  "js/notify.js?v=91",
  "css/tokens.css?v=91",
  "css/app.css?v=91",
