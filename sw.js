/* Orbita v2 Service Worker — build v85 */
const CACHE = 'orbita-v85';
const SHELL = [
  "js/data.js?v=85",
  "js/helpers.js?v=85",
  "js/emoji-picker.js?v=85",
  "js/achievements.js?v=85",
  "js/themes.js?v=85",
  "js/shell.js?v=85",
  "js/modals.js?v=85",
  "js/today.js?v=85",
  ...
  "js/app.js?v=85",
  "js/sprites.js?v=85",
  "js/legio-avatars.js?v=85",
  "js/google-calendar.js?v=85",
  "js/firebase-sync.js?v=85",
  "js/utils.js?v=85",
  "js/notify.js?v=85",
  "css/tokens.css?v=85",
  "css/app.css?v=85",
